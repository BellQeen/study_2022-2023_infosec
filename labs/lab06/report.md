...
![контекст безопасности http](image/02.png){ #fig:002 width=75% height=75%}
...
![переключатели SELinux для http](image/03.png){ #fig:003 width=75% height=75%}
...
![создание html-файла и доступ по http](image/04.png){ #fig:004 width=75% height=75%}
...
![ошибка доступа после изменения контекста](image/05.png){ #fig:005 width=75% height=75%}
...
![лог ошибок](image/06.png){ #fig:006 width=75% height=75%}
...
![переключение порта](image/07.png){ #fig:007 width=75% height=75%}
...
![доступ по http на 81 порт](image/08.png){ #fig:008 width=75% height=75%}
